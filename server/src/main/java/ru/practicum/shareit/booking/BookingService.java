...
public class BookingService {
    ...
    public Page<Booking> getBookingsByUser(int userId, BookingState state, int from, int size) {
        ...
        switch (state) {
            ...
            case PAST:
                return repository.findAllByEndIsBeforeAndBookerId(now, userId, pageable);
            case FUTURE:
                return repository.findAllByStartIsAfterAndBookerId(now, userId, pageable);
            case WAITING:
                return repository.findAllByStatusAndBookerId(WAITING, userId, pageable);
            case REJECTED:
                return repository.findAllByStatusAndBookerId(REJECTED, userId, pageable);
            default:
